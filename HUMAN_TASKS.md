...
| eyes-happy.png | Happy reaction eyes. Flat art, not colour-tinted (same as neutral eyes above). Wired into CharacterFace's `reaction="smile"` state (ticket 103). | CharacterFace component (reaction eyes, ticket 103) | todo |
| eyes-sad.png | Sad reaction eyes. Flat art, not colour-tinted. Wired into CharacterFace's `reaction="frown"` state, and also stands in for `reaction="teary"` until eyes-teary.png exists (ticket 103). | CharacterFace component (reaction eyes, ticket 103) | todo |
| eyes-teary.png | Teary reaction eyes — still no placeholder file exists at all. CharacterFace's `reaction="teary"` state currently falls back to eyes-sad.png (ticket 103 judgment call); swap it in once this lands — see the `REACTION_EYES` map in CharacterFace.vue. | CharacterFace component (reaction eyes, ticket 103) | todo |
| mouth.png | Neutral mouth. Flat art, not colour-tinted. | CharacterFace component (neutral expression) | todo |
| mouth-happy.png | Happy reaction mouth. Flat art, not colour-tinted. Wired into CharacterFace's `reaction="smile"` state (ticket 103). | CharacterFace component (reaction mouth, ticket 103) | todo |
| mouth-sad.png | Sad reaction mouth. Flat art, not colour-tinted. Wired into CharacterFace's `reaction="frown"` state (ticket 103). | CharacterFace component (reaction mouth, ticket 103) | todo |
| mouth-smirk.png | Smirk reaction mouth. Flat art, not colour-tinted. Wired into CharacterFace's `reaction="teary"` state as a stand-in for a dedicated crying mouth (ticket 103 judgment call — revisit if a `mouth-teary.png` gets made instead). | CharacterFace component (reaction mouth, ticket 103) | todo |